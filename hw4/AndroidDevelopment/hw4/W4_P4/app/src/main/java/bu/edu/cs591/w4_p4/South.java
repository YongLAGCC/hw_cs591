...
public class South extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myShakeListener = new MyShakeListener() {
            @Override
            public void onShake() {
                Toast.makeText(South.this, "Shaking!!!", Toast.LENGTH_SHORT).show();
                final Animation animShake = AnimationUtils.loadAnimation(getApplicationContext(),
                        R.anim.shake);
                ImageView imageView = (ImageView) findViewById(R.id.imgSouth);
...
//                Toast.makeText(South.this, "Up", Toast.LENGTH_SHORT).show();
