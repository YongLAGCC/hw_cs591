...
public class North extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myShakeListener = new MyShakeListener() {
            @Override
            public void onShake() {
                Toast.makeText(North.this, "Shaking!!!", Toast.LENGTH_SHORT).show();
                final Animation animShake = AnimationUtils.loadAnimation(getApplicationContext(),
                        R.anim.shake);
                ImageView imageView = (ImageView) findViewById(R.id.imgNorth);
...
//                Toast.makeText(North.this, "Down", Toast.LENGTH_SHORT).show();
