...
public class East extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myShakeListener = new MyShakeListener() {
            @Override
            public void onShake() {
                Toast.makeText(East.this, "Shaking!!!", Toast.LENGTH_SHORT).show();
                final Animation animShake = AnimationUtils.loadAnimation(getApplicationContext(),
                        R.anim.shake);
                ImageView imageView = (ImageView) findViewById(R.id.imgEast);
...
//                Toast.makeText(East.this, "Left", Toast.LENGTH_SHORT).show();
