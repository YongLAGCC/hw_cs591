...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alLatLngs = new ArrayList<LatLng>();  //creating an array to store a set of Lat/Longs. (Part of in class activity, don't have to use this)
...
// Could also use the Fused Location Provider, this is just another way. //
// Two classes instead of one.  LocationManager + LocationListener work in tandom//
        lm = (LocationManager) this.getSystemService(Context.LOCATION_SERVICE);
        ll = new MyLocationListener();
        lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 2500L, 0.0f, ll);    //Question, is there a better place then onCreate for this?
...
//******************************************************************//
    ...
    //----this is what happens when a language doesn't have default parms! -----------//
